...
import com.yaful.android.ioc.db.annotation.Table;
...
public class TableUtils {
	...
	public static Column getColumnOrId(Class<?> entityType, String columnName) {
		if (getPrimaryKeyColumnName(entityType).equals(columnName)) {
			return com.yaful.android.ioc.db.table.Table.get(entityType).getId();
		}
	 ...
	 * key: entityType.canonicalName
	 */
	private static ConcurrentHashMap<String, com.yaful.android.ioc.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.yaful.android.ioc.db.table.Id>();

	public static synchronized com.yaful.android.ioc.db.table.Id getId(Class<?> entityType) {
		if (Object.class.equals(entityType)) {
		...
		com.yaful.android.ioc.db.table.Id id = new com.yaful.android.ioc.db.table.Id(entityType, primaryKeyField);
		entityIdMap.put(entityType.getCanonicalName(), id);
		return id;
	}

	private static String getPrimaryKeyFieldName(Class<?> entityType) {
		com.yaful.android.ioc.db.table.Id id = getId(entityType);
	...
	public static Object getIdValue(Object entity) {
		...
		try {
			com.yaful.android.ioc.db.table.Id id = getId(entity.getClass());
			if (id == null)
				return null;
